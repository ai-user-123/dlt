...
# XOR Gate (using standard bitwise logic as XOR cannot be represented by a single-layer MCP)
def XOR(x1, x2):
    return x1 ^ x2
...
**Experiment 2: Logistic Regression Classifier**
...
**Experiment 3: Neural Network with One Hidden Layer**
